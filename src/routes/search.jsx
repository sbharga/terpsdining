  ...
  return (
    <div className="space-y-4">
      ...
      <div className="lg:flex lg:gap-8 lg:items-start">
        ...
        <aside className={`lg:w-64 lg:shrink-0 space-y-4 ${showFilters ? '' : 'hidden lg:block'}`}>
          <Form method="get" ref={formRef} className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              <button
                type="submit"
                className="rounded-lg bg-[#E21833] px-4 py-2 text-sm font-semibold text-white hover:bg-[#c01028] active:scale-95 transition-all shadow-sm"
              >
                Search
              </button>
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-[#E21833] focus:border-transparent"
              >
        ...
        <div className="flex-1 min-w-0">
          ...
          <button
            ...
            className={`lg:hidden mb-3 inline-flex items-center gap-1.5 rounded-full border px-4 py-1.5 text-sm font-medium transition-colors
              ${showFilters
                ? 'bg-[#E21833] text-white border-[#E21833]'
            ...
            <div className="rounded-xl border border-dashed border-gray-300 p-8 text-center">
              <p className="text-gray-400 text-sm">
                {query
                  ...
                  : 'Enter a food name or select filters to get started.'}
              </p>
            </div>
          ) : (
            <>
